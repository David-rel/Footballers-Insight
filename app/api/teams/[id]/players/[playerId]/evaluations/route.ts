...
// GET - List all player evaluations for a player (newest first)
export async function GET(
  ...
  try {
    ...
    console.error("List player evaluations error:", error);
    return NextResponse.json(
      { error: "Failed to list player evaluations", details: error.message },
      { status: 500 }
    );
  }
}
